package io.zenith391.reactop.util;
...
public interface InventoryImplementation extends Inventory {
     ...
     */
    public static InventoryImplementation of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     */
    public static InventoryImplementation ofSize(int size) {
